...
def get_event_type(key, meta_df, meta_key_col_name, meta_type_col_name, fetch_type_name=False):
    ...
    for id in key:
        event_type = meta_df[meta_type_col_name].loc[meta_df[meta_key_col_name]==id].values[0]
