...
def append_y_true_col(features_df, prediction_type_nos, meta_df, meta_key_col_name, meta_type_col_name):
    ...
    """
    event_types , event_type_names = get_event_type(list(features_df["key"].values), 
                                                    meta_df=meta_df,
    ...
    features_df["y_true"] = get_y_true_values(event_types=event_types, prediction_type_nos=prediction_type_nos)
